...
| bgp\_asn | n/a | `number` | `"ASN of the Cloud Router"` | no |
...
| gateway\_name | n/a | `string` | `"The name of the VPN gateway being created"` | no |
...
| resource\_prefix | n/a | `string` | `"Resource Prefix for the GCP Resources, allow multiple instanstiation of this module"` | no |
| shared\_secrets | IKE Secret of the Tunnels | `list` | n/a | yes |
