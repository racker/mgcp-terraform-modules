...
variable "bgp_asn" {
  type = number
  default = "ASN of the Cloud Router"
}
...
variable "gateway_name" {
  type = string
  default = "The name of the VPN gateway being created"
}
...
variable "resource_prefix" {
  type = string
  default = "Resource Prefix for the GCP Resources, allow multiple instanstiation of this module"
}

variable "shared_secrets" {
  type = list
  description = "IKE Secret of the Tunnels"
}